...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT u.userId, u.db_userLoginName, u.db_password, u.StationId, u.db_usertype, u.OrgID , st.stationName 
              FROM baris_userlogin u
              LEFT JOIN baris_station st ON u.StationId = st.stationId 
              WHERE u.db_userLoginName = ?";
                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="main-menu collapse navbar-collapse" id="nav-content">
                                    <ul class="navbar-nav ml-auto align-items-lg-center">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="ihttps://www.beatleanalytics.com/index.php/beatle/aboutus">about us</a>
                                        </li>
                                        <li class="nav-item">
