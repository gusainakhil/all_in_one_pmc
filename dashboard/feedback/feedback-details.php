...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* Add descriptive text for different score badges */
            .badge[class*="bg-success"]::after,
            .print-score[class*="bg-success"]::after {
                content: " (E)"; /* Abbreviate */
                font-size: 7pt;
                font-style: italic;
                opacity: 0.8;
            }
            
            .badge[class*="bg-info"]::after,
            .print-score[class*="bg-info"]::after {
                content: " (G)"; /* Abbreviate */
                font-size: 7pt;
                font-style: italic;
                opacity: 0.8;
            }
            
            .badge[class*="bg-warning"]::after,
            .print-score[class*="bg-warning"]::after {
                content: " (A)"; /* Abbreviate */
                font-size: 7pt;
                font-style: italic;
                opacity: 0.8;
            }
            
            .badge[class*="bg-danger"]::after,
            .print-score[class*="bg-danger"]::after {
                content: " (P)"; /* Abbreviate */
                font-size: 7pt;
                font-style: italic;
                opacity: 0.8;
            }
            
            .badge[class*="bg-dark"]::after,
            .print-score[class*="bg-dark"]::after {
                content: " (VP)"; /* Abbreviate */
                font-size: 7pt;
                font-style: italic;
                opacity: 0.8;
            }
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="print-header-text print-only">
                        ...
                        <div class="text-center mb-2" style="font-size:8pt;">
                            ...
                            5=Excellent, 4=Good, 3=Average, 2=Poor, 1=Very Poor, NA=Not Rated
                        </div>
                    </div>
                    <div class="card-body">
