...
<html lang="en">
<head>
    <title>Daily Consumables Report <?php echo "$station $fromDate To $toDate"; ?></title>
        ...
        <main class="app-main">
            <div class="app-content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6"><h3 class="mb-0">Consumable Chemicals Surprise Report</h3></div>
                        <div class="col-sm-6">
                            <a href="consumablemonthlytarget.php" class="btn btn-success" target="blank">Set Monthly Target</a>
                            <a href="chemical_report_summary.php" target="blank" class="btn btn-success">Summary</a>
                            <a href="chemicalreport.php" target="blank" class="btn btn-success">Chemicals Report</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-outline mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="body" style="max-height: 80vh; overflow-y: auto; padding: 10px; border: 1px solid #ccc;">
                                        <?php
                                        if (empty($data)) {
                                            ...
                                            foreach ($data as $date => $report) {
                                                ...
                                                echo "</table><br>
                                                    ...
                                                    <span style='margin-left:20%'>CHI IN Charge</span><br>
