    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-semibold text-gray-800"> Division list</h1>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="py-2 px-4 text-left">Division Name</th>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td class='py-2 px-4 border-b'>" . htmlspecialchars($row['DivisionName']) . "</td>";
                                echo "<td class='py-2 px-4 border-b'>";
                                echo "<a href='edit-division.php?id=" . $row['DivisionId'] . "' class='text-blue-500 hover:underline'>Edit</a> | ";
                                echo "<a href='delete-division.php?id=" . $row['DivisionId'] . "' class='text-red-500 hover:underline'>Delete</a>";
                                echo "</td>";
                                echo "</tr>";
                            }
                        } else {
