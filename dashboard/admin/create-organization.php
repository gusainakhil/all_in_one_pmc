    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-semibold text-gray-800">Create organization</h1>
                <a href="../user-dashboard/user-list.php" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">organization List
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="flex border-b">
                    <button class="px-4 py-2 border-b-2 border-blue-500 text-blue-600 font-semibold">organization </button>
                </div>
                <!-- form -->
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="organization_name" required class="mt-1 block w-full border rounded px-3 py-2" placeholder="Enter organization Name" />
                            <?php
                if (isset($_GET['success']) && $_GET['success'] == 'true') {
                    echo '<div class="mt-4 text-green-600">organization created successfully!</div>';
                }
                if (isset($errorMsg)) {
